        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold">Cheryl Towey</h3>
                <p className="text-gray-400">Real Estate Professional</p>
              </div>
            </Link>
            <p className="text-gray-300 mb-6 max-w-md">
              Your trusted partner in finding the perfect home in New Jersey. 
              With over 15 years of experience, I'm committed to providing 
              exceptional service and results.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gold-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/listings" className="text-gray-300 hover:text-gold-400 transition-colors">
                  Properties
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Cheryl Towey Real Estate. All rights reserved.
            </div>
