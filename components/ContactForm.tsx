      ...
      <div className="container-max">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="scroll-animate">
              ...
              <div className="space-y-8 mb-12">
                    <div>
                      ...
                      <div className="text-lg font-serif font-light text-black">908.334.0971</div>
                    </div>
                    <div>
                      <div className="text-xs text-secondary uppercase tracking-widest mb-3 font-semibold">Email</div>
                      <div className="text-lg font-serif font-light text-black">yournjrealtor1@gmail.com</div>
                    </div>
                    <div>
                      <div className="text-xs text-secondary uppercase tracking-widest mb-3 font-semibold">Office</div>
                      <div className="text-lg font-serif font-light text-black">1625 NJ-10 East, Morris Plains, NJ 07950</div>
                    </div>
              </div>
            ...
            {/* Contact Form */}
            <div className="scroll-animate">
              <h3 className="text-2xl font-serif font-light text-black mb-2">Send a Message</h3>
              <div className="w-16 h-0.5 bg-secondary mb-8"></div>
