          ...
          <div className="container-max h-full py-16 px-8 lg:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 h-full">
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <Link
                  href="/"
                  className="text-2xl md:text-3xl font-serif font-light text-black hover:text-gold transition-colors duration-300 tracking-wide"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Home
                </Link>
                  ...
                  <div className="pl-4 space-y-2">
                    {communities.map((community) => (
                      <Link
                        key={community.name}
                        href={community.href}
                        className="block text-base md:text-lg font-serif font-light text-gray-dark hover:text-gold transition-colors duration-300"
                        onClick={() => setIsMenuOpen(false)}
                      >
                        {community.name}
                      </Link>
