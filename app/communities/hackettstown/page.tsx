      ...
      <section className="section-padding bg-gray-light">
        <div className="container-max">
          <h1 className="scroll-animate text-4xl sm:text-5xl font-serif font-light text-black mb-6 heading-underline pb-4">
            Homes for Sale in Hackettstown
          </h1>
          <p className="scroll-animate text-base text-gray-dark leading-relaxed max-w-4xl">
            Welcome to Hackettstown, New Jersey - a charming Warren County town that perfectly blends small-town atmosphere with modern amenities. Known for its historic downtown, excellent schools, and strong sense of community, Hackettstown offers beautiful homes ranging from historic properties to contemporary new construction. Enjoy easy access to shopping, dining, parks, and major highways for convenient commuting.
          </p>
        </div>
      </section>
