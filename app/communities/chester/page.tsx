      ...
      <section className="section-padding bg-gray-light">
        <div className="container-max">
          <h1 className="scroll-animate text-4xl sm:text-5xl font-serif font-light text-black mb-6 heading-underline pb-4">
            Homes for Sale in Chester
          </h1>
          <p className="scroll-animate text-base text-gray-dark leading-relaxed max-w-4xl">
            Discover Chester, New Jersey - a Morris County gem offering luxury homes, excellent shopping, and fine dining. Known for its upscale residential communities, historic charm, and vibrant downtown, Chester attracts discerning homebuyers seeking quality and sophistication. The borough features beautiful colonial homes, modern luxury estates, and convenient access to top-rated schools, boutique shopping, gourmet restaurants, and cultural amenities.
          </p>
        </div>
      </section>
