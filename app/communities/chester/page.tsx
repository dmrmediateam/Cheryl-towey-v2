        ...
        <div className="container-max">
          <div className="text-center mb-12">
            <h2 className="scroll-animate text-3xl sm:text-4xl font-serif font-light text-black mb-4">
              Available Properties in Chester
            </h2>
            <p className="scroll-animate text-base text-gray-dark max-w-2xl mx-auto">
              Discover your perfect upscale retreat in this historic Morris County gem, from elegant Main Street properties to luxury estates with scenic views.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            ...
            <Link href="/contact" className="btn-outline">
              Contact Cheryl for Luxury Listings
            </Link>
          </div>
        </div>
      </section>
