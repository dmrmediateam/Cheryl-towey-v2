...
export const metadata: Metadata = {
  title: 'Real Estate Blog & Market Insights | Cheryl Towey NJ',
  description: 'Expert real estate insights for Northwest New Jersey. Market reports, buyer tips, seller guides, and local community news from licensed agent Cheryl Towey.',
  openGraph: {
    title: 'Real Estate Blog & Market Insights | Cheryl Towey NJ',
    description: 'Expert real estate insights for Northwest New Jersey. Market reports, buyer tips, seller guides, and local community news.',
    url: 'https://www.realestatebycherylnj.com/blog',
  ...
  twitter: {
    ...
    title: 'Real Estate Blog & Market Insights | Cheryl Towey NJ',
    description: 'Expert real estate insights for Northwest New Jersey.',
  },
  alternates: {
    canonical: 'https://www.realestatebycherylnj.com/blog',
  },
};
