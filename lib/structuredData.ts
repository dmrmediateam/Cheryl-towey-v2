...
export const businessData = {
  name: 'Cheryl Towey - Morris County NJ Realtor | Weichert Realtors',
  agentName: 'Cheryl Towey',
  company: 'Weichert Realtors',
  description: 'Morris County NJ realtor and licensed real estate agent - Cheryl Towey specializes in residential properties in Morris, Sussex, and Warren Counties. Your trusted Northwest New Jersey real estate expert.',
  ...
  priceRange: '$$$',
  slogan: 'Your Trusted Morris County NJ Realtor - Northwest New Jersey Real Estate Expert',
  missionStatement: 'Providing exceptional real estate services with local expertise and personal dedication to help you find your dream home in Morris County and Northwest New Jersey.',
  certifications: [
